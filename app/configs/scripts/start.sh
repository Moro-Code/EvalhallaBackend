...
export EVALHALLA_BASIC_AUTH_USERNAME=${EVALHALLA_BASIC_AUTH_USERNAME}
export EVALHALLA_BASIC_AUTH_PASSWORD=${EVALHALLA_BASIC_AUTH_PASSWORD}
export EVALHALLA_BASIC_AUTH_REALM=${EVALHALLA_BASIC_AUTH_REALM}
...
echo "export EVALHALLA_BASIC_AUTH_USERNAME=${EVALHALLA_BASIC_AUTH_USERNAME}" >> /etc/default/celeryd
echo "export EVALHALLA_BASIC_AUTH_PASSWORD=${EVALHALLA_BASIC_AUTH_PASSWORD}" >> /etc/default/celeryd
echo "export EVALHALLA_BASIC_AUTH_REALM=${EVALHALLA_BASIC_AUTH_REALM}" >> /etc/default/celeryd
